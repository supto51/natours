...
if (document.getElementById("map")) {
  ...
  mapboxgl.accessToken = "pk.eyJ1Ijoic3VwdG8wNyIsImEiOiJja3hvaThzczcwMDN5MndvMndveWdmNXFzIn0.UPx2McrwLFuvcCI-BaNitw";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            showAlert("error", _context.t0.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            showAlert("error", _context2.t0.message);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            showAlert("error", _context3.t0.message);
